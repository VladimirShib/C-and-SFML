// Rotate triangle in mouse direction
...
void update(const sf::Vector2f &mousePosition, sf::ConvexShape &pointer)
{
    ...
    // Принимает координаты y и x (именно в таком порядке, т.к. это числитель и знаменатель)
    // и возвращает корректный угол в радианах в диапазоне [-PI, PI]
